...
jQuery(document).ready(function ($) {
    Drupal.behaviors.oc_ting_reference_cover_preview = {
        attach: function (context, settings) {
            ...
            try {
                ...
                if(idstr != undefined && idstr.indexOf('field-ding-page-materials-add-more-wrapper') !== -1)
                {
                    var Inputs = $('.field-name-field-ding-page-materials input[value!=""]:not(".ajax-processed")');
                    Inputs.trigger('blur');
                }
            } catch (e) {
    ...
    function init_cover_preview()
    {
        ...
        */
       var Inputs = $('.field-name-field-ding-page-materials').on('blur','input',update_preview);
        /*
