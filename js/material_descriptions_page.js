(function ($) {
     ...
     */
    Drupal.behaviors.material_description_page = {
        attach: function (context, settings) {
             ...
             */
            var elem = $('.field-name-field-ding-page-materials').find('input[type="submit"]');
            elem.mousedown(function () {
                var material_children = $('.field-name-field-ding-page-materials').find('.form-item').length;
                var description_children = $('.field-name-field-ding-page-material-descrip').find('.form-item').length;
                if (material_children >= description_children)
                {
                    setTimeout(function(){
                        $('.field-name-field-ding-page-material-descrip').find('input[type="submit"]').mousedown();
                    },650);
                }
            });
            /*
            ...
            var inputs = $('#edit-field-ding-page-material-descrip table input:not(.field-add-more-submit)');
            inputs.unbind('click');
